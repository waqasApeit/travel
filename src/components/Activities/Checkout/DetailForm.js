    ...
    return (
        <div>
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="">
                            <div className="form-check form-check-inline">
                                ...
                                <label className="form-check-label" for="leadRadio1">Male</label>
                            </div>
                            <div className="form-check form-check-inline">
                                ...
                                <label className="form-check-label" for="leadRadio2">Female</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {otherGuestDetail.map((item, index) => (
                    <div key={index} className="row my-4">
                        <div className="col-12 d-flex justify-content-between align-items-center">
                            <h5>Traveler {index + 2} {(item.type === 'CH' || item.type === 'IN') && <span style={{ fontSize: '12px' }} className="small bg-secondary-subtle rounded px-1 py-1">{item.type === 'CH' ? 'Child' : 'Infant'}</span>}</h5>
            ...
            <div className='bg-success-subtle rounded p-3 mt-3'>
                <div className='text-success'><IoShieldCheckmarkOutline /> All transactions are encrypted and 100% safe.</div>
                <div className='text-success'><CiCircleCheck /> Your booking is confirmed immediately after payment.</div>
                <div className='text-success'><IoPersonAddOutline /> Join thousands of satisfied travelers who booked with us.</div>
                <div className='text-success'><BiSupport /> Our customer service is here to assist you anytime.</div>
            </div>
            {/* <div className="mt-3">
                ...
                <div className="border rounded p-3 bg-white shadow-sm">
                    <div className="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div className="small text-muted">Pay securely using your debit or credit card.</div>
                        </div>
                        {/* <div>
                    ...
                    {/* {bookingOptionDetails === 'card' && ( */}
                        <div>
                            <div className="small mt-3 text-muted">To complete your booking, you will need to enter the cardholder’s name as shown on the card, the card number, expiry date, and the CVC/CVV security code. In some cases, your bank may also request billing address verification for added security. All card details are encrypted and processed through a secure payment gateway to ensure your information remains safe.</div>
                            <div className="col-12 mt-3 d-flex justify-content-end">
                                <button type="button" className="btn btn-success" disabled={loading} onClick={handleCheckout}>
