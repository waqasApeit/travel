...
export default function SectionOne() {
  return (
    ...
    //             <p className={styles.sectionOnePara}>At Al Hijaz Tours, we are dedicated to providing each pilgrim with compassionate care and comfort.<br/> Explore our Hajj or Umrah packages to book easily and have a memorable pilgrimage experience.</p>
