...
import { FaSun, FaMoon, FaFacebookF, FaTwitter, FaLinkedinIn } from "react-icons/fa";
    ...
    return (
        <div className={styles.islamicHeaderOther}>
            ...
            <div className={styles.islamicTopBar}>
                    <div className={`${styles.islamicTopBarContent} container d-flex justify-content-between align-items-center`}>
...
>
  ...
  <span className={styles.islamicTopBarText}>+92 111 222 33333</span>
</a>
                            </div>
                        </div>
                         <div className={`${styles.islamicTopBarLeft} d-flex align-items-center gap-4`}>
                            <div className={`${styles.islamicTopBarItem} d-none d-md-flex align-items-center gap-2`}>
                                ...
                                <span className={styles.islamicTopBarText}>Stratford Road Birmingham, UK</span>
                            </div>
                ...
                <div className="container">
                    ...
                    <div className={`${styles.islamicDesktopMenu} d-none d-lg-flex`}>
                        ...
                        <div className={`${styles.islamicNavActions} d-flex align-items-center gap-3`}>
                            <a href="tel:+9211122233333" className={styles.islamicPhoneLink}>
