                  ...
                  <div className="card-body p-4">
                    <div className="row g-3 mb-4">
                      <div className="col-md-4">
                        <div className={styles.infoCard}>
                          <small className={styles.infoLabel}>INVOICE NO</small>
                    ...
                    {(voucherDetail?.other_passengers?.additional_adults
                      ...
                      voucherDetail?.other_passengers?.children_details
                        ?.length > 0 ||
                      voucherDetail?.additional_adults?.infants_details
                        ?.length > 0) && (
                      <div className="mb-4">
                        ...
                        <div className="table-responsive">
                          <table className={`${styles.modernTable} table mb-0`}>
                            ...
                            <tbody>
                              ...
                              {voucherDetail?.additional_adults?.children_details.map(
                                (child, index) => (
                                  <tr key={index}>
                                    <td>
                              ...
                              {voucherDetail?.additional_adults?.infants_details.map(
                                (infant, index) => (
                                  <tr key={index}>
                                    <td>
                        ...
                        <table className={`${styles.modernTable} table mb-0`}>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                {voucherDetail?.customer_currency}{" "}
                                {convertToCustomerCurrency(
                                  voucherDetail?.activity?.sale_price,
                                )}
                              </td>
                              <td>
                                {voucherDetail?.customer_currency}{" "}
                                {convertToCustomerCurrency(
                                  voucherDetail?.adult_price,
                                )}
                              </td>
                            </tr>
                                ...
                                {voucherDetail?.additional_services.map(
                                  (item, index) => (
                                    <tr key={index}>
                                      ...
                                      <td>
                                        {voucherDetail?.customer_currency}{" "}
                                        {convertToCustomerCurrency(item?.price)}
                                      </td>
                                      <td>
                                        {voucherDetail?.customer_currency}{" "}
                                        {convertToCustomerCurrency(item?.total)}
                                      </td>
                                    </tr>
                                  ),
                                )}
                    ...
                    <div className="row g-3 mt-2">
                      <div className="col-lg-7">
                        <div className={styles.noteBox}>
                          <h6 className="fw-bold mb-2">Please Note:</h6>
                          <p className="small mb-0 text-muted">
                            This invoice displays the complete pricing details
                            of your booking, inclusive of all applicable taxes.
                            Please verify the information and retain this
