        ...
        <>
            ...
            <div className='container my-5'>
                <div className='hotel-checkout-top'>
                    <h2 className={`fw-bold text-center ${philosopher.className}`}>Terms and Conditions</h2>
                </div>
                <p className={`text-justify ${philosopher.className}`}>At Kashta Travels, we are committed to providing pilgrims with a safe, comfortable, and spiritually enriching journey. Our Hajj and Umrah packages are designed to simplify every step of your pilgrimage. These Terms and Conditions outline your rights, responsibilities, and our services to ensure a smooth and transparent experience.</p>
                <h4 className={`mb-0 fw-bold ${philosopher.className}`}>Booking and Confirmation</h4>
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Payment Policy</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Cancellation and Refunds</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Changes to Packages</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Responsibilities and Liability</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Travel Documents and Visa</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Code of Conduct</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Ziyarat and Religious Guidance</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Privacy and Data Protection</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Governing Law</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Your Journey, Our Commitment</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
