...
export default function MealType() {
  ...
  return (
    <div>
      ...
      <div>
        <Checkbox
          checked={meal.includes("room only")}
          onChange={() => handleCheckboxChange("room only")}
          className="mt-2"
          label="Room Only"
        />
         <Checkbox
        ...
        />
        <Checkbox
          checked={meal.includes("half board")}
          onChange={() => handleCheckboxChange("half board")}
          className="mt-2"
          label="Half Board"
        />
        <Checkbox
          checked={meal.includes("full board")}
          onChange={() => handleCheckboxChange("full board")}
          className="mt-2"
          label="Full Board"
        />
        <Checkbox
          checked={meal.includes("dinner")}
