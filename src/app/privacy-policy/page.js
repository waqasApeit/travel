        ...
        <div>
            <div className='container my-5'>
                <div className='hotel-checkout-top'>
                    <h2 className={`fw-bold text-center ${philosopher.className}`}>Privacy and Security Policy</h2>
                </div>
                <p className={`text-justify ${philosopher.className}`}>Your privacy matters to us. At Kashta Travels, we value your trust and take the protection of your personal information very seriously. This document explains the data we collect, how we use it, and the steps we take to safeguard your information.</p>

                <h4 className={`mb-0 fw-bold ${philosopher.className}`}>Why We Collect or Process Your Personal Data?</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                    We cannot help you plan or book the perfect Kashta Travels and services without your information. The main purpose of collecting personal details is to provide the requested tours or services, ensure you receive the best service, or for other purposes for which you have given your consent, except where otherwise required by law. Your data also helps us improve our services.
                </Blockquote>

                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>When Do We Collect or Process Your Personal Data?</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>What Kinds of Information We Collect?</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>How Do We Use Your Information?</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                    <ul>
                        <li>
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>How Do We Protect Your Information?</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>Third-Party Responsibility and Your Responsibility</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
                    Our website may contain links to other sites such as Facebook, YouTube, etc. When visiting these sites, your data is governed by their privacy policies. Kashta Travels is not responsible for data protection on these sites.
                    <div className='mt-3'>
                ...
                <h4 className={`mb-0 mt-4 fw-bold ${philosopher.className}`}>How to Contact Us?</h4>
                <Blockquote color="darkred" className='mt-2' mt="xl">
