    ...
    return (
        <>
            ...
            <div className='container my-5'>
                ...
                <Blockquote color="darkgreen" className='mt-2' mt="xl">
                    Al Hijaz Tours reserves the right to make changes to itineraries, hotels, flights, or ground services if operational circumstances require it. We will communicate any major changes promptly and work with you to minimize inconvenience. Minor adjustments may occur due to local regulations or service providers.
                </Blockquote>
                <h4 className='mb-0 mt-4'>Responsibilities and Liability</h4>
                <Blockquote color="darkgreen" className='mt-2' mt="xl">
                    Pilgrims are responsible for ensuring passports, visas, vaccinations, and personal belongings are complete and accurate. Al Hijaz Tours is not liable for delays, cancellations, or other circumstances outside our control, including airline changes, government regulations, or unforeseen events. We strongly recommend travel insurance to cover unexpected incidents.
                </Blockquote>
                ...
                <Blockquote color="darkgreen" className='mt-2' mt="xl">
                    At Al Hijaz Tours, we are working to make your Hajj or Umrah experience meaningful and unforgettable. By following these Terms and Conditions, both pilgrims and our team can ensure a safe, organized, and spiritually rewarding journey.
                </Blockquote>
            </div>
        </>
    )
